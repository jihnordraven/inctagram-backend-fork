import { emailConfirmHTML } from 'src/libs/static/templates/email-confirm.template'
import { passwordRecoveryHTML } from 'src/libs/static/templates/password-recovery.template'
